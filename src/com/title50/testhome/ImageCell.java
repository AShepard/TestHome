...
public void onDropCompleted (View target, boolean success)
{
    ...
    if (success) {
       mEmpty = true;
       if (mCellNumber >= 0) {
          int bg = mEmpty ? 0 : R.color.cell_filled;
        ...
        DragView dragView, Object dragInfo)
{
    ...
    //Get new app info
    ApplicationInfo app = dragView.getAppInfo();
    setAppInfo(app);
...
public void onDragEnter(DragSource source, int x, int y, int xOffset, int yOffset,
        DragView dragView, Object dragInfo)
{
    int bg = R.color.cell_filled_hover;
...
public void onDragOver(DragSource source, int x, int y, int xOffset, int yOffset,
        DragView dragView, Object dragInfo)
{
	int bg = mEmpty ? R.color.cell_filled_hover : R.color.cell_filled;
...
{
    if (!TestHomeActivity.Debugging) return;
